// The nametag card. Two variants: 'sticker' (literal HELLO badge) and
// 'editorial' (brand portrait card), plus the Avatar and corner WaveChip.
// Ported from the redesign handoff (design_files/badge.jsx).
import { initials, distanceLabel } from './badgeUtils';

// Circle avatar. Photo → cover image; otherwise an initial-monogram on an
// accent tint (no illustrated faces). `accent` is a CSS color/var reference.
...
// One person's nametag. variant 'sticker' (default) or 'editorial'.
// waveState 'sent' | 'incoming' renders the corner WaveChip.
